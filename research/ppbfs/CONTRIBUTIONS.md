...
| P7: WALK post-saturation bookkeeping | `research/ppbfs-lab` | `contrib/ppbfs-walk-post-saturation-bookkeeping` | `736cad02a36bb4a0d32c1064f44768339c814269` | clean contribution candidate; end-to-end/JFR qualification pending | Walk repeated-diamond d=6: 948 to 200 pushes (4.74x); differential metadata equality; bound/Trail zero delta | neo4j/neo4j#13968 (open) |
